  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap gap-4">
        <Select
          value={selectedStatus || "not-selected"}
          onValueChange={(value) => setSelectedStatus(value === "not-selected" ? null : value as Status)}
        >
          <SelectTrigger className="w-[180px]">
            <SelectValue placeholder="Filter by status" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="not-selected">All Status</SelectItem>
